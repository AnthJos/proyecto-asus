...
<body>
    ...
    <div class="titulo">
        <div class="container">
            <div class="row"><img src="img/titulos/titu-phone.png" class="titu img-responsive"></div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <?php
                  ...
                  $re=mysqli_query($con,"select * from celulares")or die(mysqli_error());
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail"><img src="img/productos/<?php echo $f['imagen'];?>" class="img-responsive">
                            <div class="caption">
                                ...
                                <p class="boton" onclick="recarga();"><a href="carrito.php?id=<?php echo $f['id'];?>" role="button" class="btn btn-info" ><i aria-hidden="true" class="fa fa-shopping-basket"> Añadir al carrito</i></a></p>
                            </div>
                        </div>
                    </div>
                  <?php } ?>
