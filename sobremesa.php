...
<body>
    ...
    <div class="titulo">
        <div class="container">
            <div class="row"><img src="img/titulos/titu-sobre.png" class="titu img-responsive"></div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <?php
                  ...
                  $re=mysqli_query($con,"select * from sobremesa")or die(mysqli_error());
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail"><img src="img/productos/<?php echo $f['imagen'];?>" class="img-responsive">
                            <div class="caption">
                                ...
                                <p>
                                    <?php echo utf8_encode($f['descripcion']);?>
                                </p>
                                <p>A solo :</p>
